...
while True:
	...
	sql = "INSERT INTO sensor_room_his(time, id ,name, value) VALUES (%d, '%s', '%s', %.1f)" % \
		  (time, '0x00000220', 'room_temp1', Temperature_1)
	cursor.execute(sql)
	sql = "INSERT INTO sensor_room_his(time, id ,name, value) VALUES (%d, '%s', '%s', %.1f)" % \
		  (time, '0x00000221', 'room_RH1', Humidity_0)
	cursor.execute(sql)
	sql = "INSERT INTO sensor_room_his(time, id ,name, value) VALUES (%d, '%s', '%s', %.1f)" % \
		  (time, '0x00000222', 'room_temp2', Temperature_3)
	cursor.execute(sql)
	sql = "INSERT INTO sensor_room_his(time, id ,name, value) VALUES (%d, '%s', '%s', %.1f)" % \
		  (time, '0x00000223', 'room_RH2', Humidity_2)
	cursor.execute(sql)
	...
	if time == 0:
		...
		cursor.execute(sql)
		sql = "UPDATE sensor_room SET time=%d, value=%.1f WHERE name='%s'" % (time, Temperature_1, 'room_temp1')
		cursor.execute(sql)
		sql = "UPDATE sensor_room SET time=%d, value=%.1f WHERE name='%s'" % (time, Humidity_0, 'room_RH1')
		cursor.execute(sql)
		sql = "UPDATE sensor_room SET time=%d, value=%.1f WHERE name='%s'" % (time, Temperature_3, 'room_temp2')
		cursor.execute(sql)
		sql = "UPDATE sensor_room SET time=%d, value=%.1f WHERE name='%s'" % (time, Humidity_2, 'room_RH2')
		cursor.execute(sql)
	db.commit()
